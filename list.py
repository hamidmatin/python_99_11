...
def ref_type_vs_value_type():
    ...
    print(
        f'nomarat = {nomreh_list}, sum = {result[0]}, copy of nomarat = {result[1]}'
    )

    result2 = sum_with_copy(list_1)
    print(
        f'List 1 = {list_1}, result[0] = {result2[0]}, result[1] = {result2[1]}'
    )
...
def slicing():
    list = [
        "grapefruit", "pineapple", "blueberries", "mango", "banana", "Lion",
        "Tiger", "Zebra", "pronghorn", "alligator", "bison", "metro", "tesco",
